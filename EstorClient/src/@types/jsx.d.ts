import { Component, VDOMElement } from './api';
import { Attributes, ClassAttributes, HTMLProps } from './common';
export { }
...
declare global {
  ...
  namespace JSX {
    ...
    interface IntrinsicElements {
      ...
      // Extend with your lit components.
      // Note: you do not need to do this if you don't use
      // lit components inside of JSX components.
      ["wc-lit-example"]: any;
